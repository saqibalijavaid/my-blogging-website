...
//   const handleStartReading = () => {
//     navigate(isLoggedIn ? "/posts" : "/signup");
//   };

//   return (
//     <div className="relative flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-[#1e3c72] to-[#2a5298] overflow-hidden">
//       {/* Floating Blur Effect */}
//       <div className="absolute top-0 left-0 w-96 h-96 bg-pink-400 opacity-30 blur-[120px] rounded-full animate-float"></div>
//       <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-400 opacity-30 blur-[120px] rounded-full animate-float-delay"></div>
...
//         whileHover={{ scale: 1.05, y: -5 }}
//         whileTap={{ scale: 0.95 }}
//         className="mt-8 px-12 py-4 text-lg md:text-xl font-semibold rounded-full bg-gradient-to-r from-pink-500 to-purple-500 text-white transition-all duration-300 hover:from-pink-600 hover:to-purple-600 shadow-xl hover:shadow-2xl"
//         onClick={handleStartReading}
//       >
//         Start Reading
//       </motion.button>
...
//         <div className="grid grid-cols-12 gap-4 h-full w-full">
//           {Array.from({ length: 144 }).map((_, index) => (
//             <div key={index} className="border border-gray-300 rounded-lg"></div>
//           ))}
//         </div>
//       </div>
//     </div>
