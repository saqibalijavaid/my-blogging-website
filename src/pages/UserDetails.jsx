...
//               <button
//                 type="submit"
//                 className="bg-blue-600 text-white py-2 px-4 rounded-lg text-lg font-medium hover:bg-blue-700 transition"
//               >
//                 Save Changes
//               </button>
//               <button
...
//             className="w-full bg-blue-500 text-white py-2 rounded-lg text-lg font-medium hover:bg-blue-600 transition mt-4"
//           >
//             Edit Profile
//           </button>
//         )}
