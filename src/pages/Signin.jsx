        ...
        <div className="absolute inset-0 opacity-10">
          <svg viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
            ...
            <g fill="none" stroke="url(#a)" strokeWidth="2">
              ...
              <circle className="animate-pulse" style={{animationDelay: "0.2s"}} cx="500" cy="500" r="350"/>
              <circle className="animate-pulse" style={{animationDelay: "0.4s"}} cx="500" cy="500" r="400"/>
              <circle className="animate-pulse" style={{animationDelay: "0.6s"}} cx="500" cy="500" r="450"/>
              <circle className="animate-pulse" style={{animationDelay: "0.8s"}} cx="500" cy="500" r="500"/>
              <circle className="animate-pulse" style={{animationDelay: "1s"}} cx="500" cy="500" r="550"/>
            </g>
            <path d="M0,1000 C300,800 600,800 1000,1000" fill="none" stroke="url(#b)" strokeWidth="3" className="animate-pulse" style={{animationDuration: "5s"}}/>
            <path d="M0,900 C300,700 600,700 1000,900" fill="none" stroke="url(#b)" strokeWidth="3" className="animate-pulse" style={{animationDuration: "6s", animationDelay: "0.3s"}}/>
            <path d="M0,800 C300,600 600,600 1000,800" fill="none" stroke="url(#b)" strokeWidth="3" className="animate-pulse" style={{animationDuration: "7s", animationDelay: "0.6s"}}/>
          </svg>
        </div>
          ...
          <div className="max-w-md mx-auto text-center backdrop-blur-sm bg-indigo-900/30 p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-500">
            <div className="h-20 w-20 mx-auto mb-8 bg-gradient-to-tr from-white to-indigo-300 rounded-xl shadow-lg transform -rotate-12">
              <div className="h-full w-full flex items-center justify-center transform rotate-12">
                {/* Logo placeholder */}
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-indigo-900" viewBox="0 0 20 20" fill="currentColor">
            ...
            <h1 className="text-4xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-indigo-200">Innovatica</h1>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white relative">
        <div className="w-full max-w-md relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Your journey of innovation continues here</p>
          </div>
          ...
          <form onSubmit={handleSignin} className="space-y-6">
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <svg className={`h-5 w-5 text-indigo-500 group-hover:text-indigo-400 transition-all duration-200 ${isLoading ? 'animate-spin' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  {isLoading ? (
